...
function updateObject() {
  ...
  if (
    ...
    let hublink =
      "https://forms-qa-sheffield.squiz.cloud/CRMHousing/default.asp?screenId=personDetails&crmAgentId=" +
      agentId +
      "&hmsPersonId=" +
      hubperson +
      "&refreshParam=<xref1>&dummy=<!2!/CurrentTime/Time!>";
    let hublink2 =
      "https://forms-qa-sheffield.squiz.cloud/CRMHousing/default.asp?screenId=GLO8&entityType=PERSON&eventCategory=PERSONNOTES&entityId1=" +
      hubperson +
      "&crmAgentId=" +
      agentId +
      "&refreshParam=<xref1>&dummy=<!2!/CurrentTime/Time!>";
...
function progressToForm() {
  ...
  window.location =
    "https://forms-qa-sheffield.squiz.cloud/form/launch/" +
...
function finishInteraction() {
  ...
  if (
    ...
    KDF.setVal("txt_branch", "firstpoint");
    window.location =
      "https://forms-qa-sheffield.squiz.cloud/form/launch/a_menu?branch=firstpoint" +
      agentparams;
  } else if (
    [
      "Burngreave",
    ...
    KDF.setVal("txt_branch", "page_hsgipmenu");
    window.location =
      "https://forms-qa-sheffield.squiz.cloud/form/launch/hsg_menu?branch=page_hsgipmenu" +
      agentparams;
  } else if (
    KDF.getVal("le_channel") === "voice_in" &&
    KDF.getVal("txt_agentlocation") === "Contact Centre"
    ...
    window.location =
      "https://forms-qa-sheffield.squiz.cloud/form/launch/hsg_menu?branch=page_hsgccmenu" +
      agentparams;
  } else {
    window.location =
      "https://forms-qa-sheffield.squiz.cloud/form/launch/a_menu?" +
      agentparams;
  }
}
